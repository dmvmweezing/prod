...
/*resttest*/
  ...
  if($focus==1)
    {
      ...
      {
        $url="http://rest01-prodv01-serv:5051/valideer/" . $_POST['txt_naam'] . "/" . $_POST['txt_password'];
  ...
  if($focus==2)
   {
     $url="http://rest02-prodv01-serv:5052/hoofdstad/" . $_POST['txt_land'];
...
<body>
   <h1>Testapplicatie voor DEVOPS, VERSIE-01 en Hello World</h1>
